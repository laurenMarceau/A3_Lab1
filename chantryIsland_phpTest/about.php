...
<header>
  ...
  <div id="siteCon">
    ...
    <img src="images/sunset.jpg" alt="Sunset on Chantry Island" id="sunset">
    <img src="images/sunsetDesktop.jpg" alt="Sunset on Chantry Island" id="sunsetDesktop">
    ...
    <article id="lightHouseHistory">
    <img src="images/lighthouseHistory.jpg" alt="Aerial of Chantry Island" id="lightHistory">
    ...
    <article id="BirdSanc">
    <img src="images/birds.jpg" alt="Photo of Bird" id="birdPhoto">
    ...
    <img src="images/lightKeepersBefore.jpg" alt="Lighthouse aerial photo" id="lighthouseBefore">
    <img src="images/lightKeeperBeforeDesktop.jpg" alt="Lighthouse aerial photo" id="lighthouseBeforeDesktop">

    <h2>Light Keeper's Cottage Before Resoration</h2>
    ...
    <p>
      ...
      <br><br>
      In 1997 the local Marine Heritage Society established specific goals for the island's restoration. The project was to be funded by donations and fundraising efforts, and the majority of the work was to be done by volunteers. With permission from 5 levels of government, the group of volunteers began to rebuild the light keeper’s cottage, using the original structure plans
    </p>

    <article id="lightKeeperCottage">
    <h2>Light Keeper's Cottage & Grounds After Restoration</h2>

    <img src="images/cottageAfter.jpg" alt="Keeper's cottage" id="cottageAfterPhoto">
    ...
    <img src="images/divider.svg" alt="Fancy divider" id="dividerThanks">
