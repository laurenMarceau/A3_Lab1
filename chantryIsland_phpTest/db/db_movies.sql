...
--
-- Host: localhost
-- Generation Time: Jan 24, 2017 at 08:15 PM
...
CREATE TABLE tbl_user (
  ...
  failed_attempt_time datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO tbl_user (user_id, user_fname, user_lname, user_name, user_pass, user_level, user_ip, login_attempt, failed_attempt_time) VALUES
(1, 'Justin William', 'Brunner', 'jbrunner', 'password', '1', '::1', 3, NULL),
(2, 'justin', 'brunner', 'jbrunner', 'Yr5v+C', '1', '0', 3, NULL);
